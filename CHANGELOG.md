...
- feat: dont postinstall in docker [#30](https://github.com/OverTheAirBrew/brewery-management-platform/pull/30) ([@sharpn](https://github.com/sharpn))
- feat: only run dedupe on local [#29](https://github.com/OverTheAirBrew/brewery-management-platform/pull/29) ([@sharpn](https://github.com/sharpn))
...
- chore: remove eslint ([@sharpn](https://github.com/sharpn))
